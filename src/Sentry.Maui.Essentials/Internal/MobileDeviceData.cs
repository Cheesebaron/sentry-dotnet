...
internal static class MobileDeviceData
{
    public static void ApplyMobileDeviceData(this Device device, IDiagnosticLogger? logger)
    {
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            logger?.LogError(ex, "Error getting Mobile device information");
        }
    }
}
